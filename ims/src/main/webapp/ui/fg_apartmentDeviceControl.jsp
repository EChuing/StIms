...
<div>
    ...
    <div style="margin:5px 0 5px 5px;color:black;float:left;">
        ...
        <input id="searchCommunity" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryApartmentDevice()')" style="width:100px">
    </div>
    <div style="margin:5px 0 5px 5px;color:black;float:left;">
        <label for="searchBuilding">楼栋：</label>
        <input id="searchBuilding" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryApartmentDevice()')" style="width:100px">
    </div>
    <div style="margin:5px 0 5px 5px;color:black;float:left;">
        <label for="searchDoorplateno">门牌号：</label>
        <input id="searchDoorplateno" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryApartmentDevice()')" style="width:100px">
    </div>
    <div style="clear:both"></div>
</div>
...
<script src="js/fg_apartmentDeviceControl.js"></script>
</html>
