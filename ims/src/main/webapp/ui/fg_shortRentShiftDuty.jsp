...
<body>
	...
	<div style="padding:30px 10px 5px 10px;height:80%">
		<table id="shiftWorkDg" style="width:99%;height:527px;table-layout:fixed;overflow:hidden;"
...
<%--		<div id="shiftWorkDiv" style="width:100%;height:30px;text-align:center;"></div>--%>
		<div id="shiftWorkPageDiv" style="width:100%;height:30px;text-align:center;"></div>
	</div>
	...
	<script src="js/fg_shortRentShiftDuty.js"></script>
