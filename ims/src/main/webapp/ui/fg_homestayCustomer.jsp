...
<body>
	...
	<div>
		<div style="margin:10px 0 15px 10px;float: left ">
			...
			<div style="margin:0 0 5px 5px;float:left;">
				电话：<input id="searchPopulationPhone" onkeyup="searchOnkeyup(this.id, 'getListContract(1, 0)')" style="width:80px">
			</div>
			<div style="margin:0 0 5px 5px;float:left;">
			...
			<div style="margin:0 0 5px 5px;padding:0 0 5px 17px;color:black;float:left;">
	...
	<!-- 客户详细信息窗口 -->
	<div id="populationDetailedDlg" style="padding:6px;width: 695px" class="easyui-dialog" data-options="closed:true">
	...
	<script src="js/fg_homestayCustomer.js"></script>
</body>
</html>