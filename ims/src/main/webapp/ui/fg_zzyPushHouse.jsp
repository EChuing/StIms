...
<body>
	...
	<div>
		<div style="padding:5px 0 0 5px;">
			<a class="easyui-linkbutton" iconCls="icon-fabu" plain="true" id="" onclick="pushHouseDlg()">发布房源</a>
			<a class="easyui-linkbutton" iconCls="icon-bianji" plain="true" id="" onclick="updatePushHouseDlg()">修改并重新发布</a>
			<a class="easyui-linkbutton" iconCls="icon-shangjia" plain="true" id="" onclick="updateHouseStatus()">上架/下架</a>
	...
	<div id="pushHouseDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style='margin:5px 0 0 5px;float:left;'>
			选择房源：<input id="bindAddress" style="width:265px;cursor:pointer;" readonly onclick="chooseHouseForStore()" require="require" clear="clear" value="海滨城花园1号楼3单元208室">
		...
		<div style='margin:5px 0 0 5px;float:left;'>
			所属城市：<input id="cityName" style="width:100px;" require="require" clear="clear" value="武汉">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			所属城区：<input id="countyName" style="width:100px;" require="require" clear="clear" value="沌口开发区">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			所属商圈：<input id="areaName" style="width:100px;" require="require" clear="clear" value="后官湖大道">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			所属小区：<input id="districtName" style="width:100px;" require="require" clear="clear" value="海滨城花园">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			小区详细地址：<input id="street" style="width:150px;" require="require" clear="clear" value="海滨城路2号">
		</div>
		<div style="clear:both"></div>
		<div style='margin:5px 0 0 17px;float:left;'>
			门牌号：<input id="address" style="width:100px;" require="require" clear="clear" value="1号楼3单元208室">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
		...
		<div style='margin:5px 0 0 29px;float:left;'>
			朝向：<select id="faceToType" style="width:100px;" choose="choose">
				...
				<option value="61" selected="selected">南</option>
		...
		<div style='margin:5px 0 0 5px;float:left;'>
			有无电梯：<select id="hasLift" style="width:100px;" require="require" choose="choose">
				<option></option>
				<option value="2" selected="selected">有</option>
		...
		<div style="clear:both"></div>
		<div style='margin:5px 0 0 17px;float:left;'>
			房间数：<input id="bedRoomNum" style="width:100px;" require="require" clear="clear" value="2">
		</div>
		<div style='margin:5px 0 0 17px;float:left;'>
			客厅数：<input id="livingRoomNum" style="width:100px;" require="require" clear="clear" value="1">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			卫生间数：<input id="toiletNum" style="width:100px;" require="require" clear="clear" value="1">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			楼层总数：<input id="totalFloor" style="width:100px;" require="require" clear="clear" value="18">
		</div>
		<div style='margin:5px 0 0 41px;float:left;'>
			楼层数：<input id="houseFloor" style="width:150px;" require="require" clear="clear" value="2">
		</div>
		<div style="clear:both"></div>
		<div style='margin:5px 0 0 29px;float:left;'>
			面积：<input id="rentRoomArea" style="width:100px;" require="require" clear="clear" value="80">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			起租时间：<input id="rentStartDate" style="width:100px;" require="require" clear="clear" value="2018-10-01"
		...
		<div style='margin:5px 0 0 5px;float:left;'>
			压付方式：<select id="paymentMode" style="width:100px;" require="require" choose="choose">
				...
				<option value="161" selected="selected">押二付一</option>
				<option value="162">押二付三</option>
			</select>
		</div>
		<div style='margin:5px 0 0 53px;float:left;'>
			租金：<input id="monthRent" style="width:150px;" require="require" clear="clear" value="5000">
		</div>
		<div style='margin:5px 0 0 17px;float:left;'>
			联系人：<input id="agentName" style="width:100px;" require="require" clear="clear" value="张三">
		</div>
		<div style='margin:5px 0 0 5px;float:left;'>
			联系电话：<input id="agentPhone" style="width:100px;" require="require" clear="clear" value="13466666666">
		</div>
		<div style='margin:5px 0 0 29px;float:left;'>
			经度：<input id="xCoord" style="width:100px;cursor:pointer;" require="require" clear="clear" readonly="readonly" onclick="openMap(1)" value="114.310149">
		</div>
		<div style='margin:5px 0 0 29px;float:left;'>
			纬度：<input id="yCoord" style="width:100px;cursor:pointer;" require="require" clear="clear" readonly="readonly" onclick="openMap(1)" value="30.59884">
		</div>
		<div style="clear:both"></div>
		<div id="featureTag">
		...
		<div style='margin:5px 0 0 0;'>
			<div style='margin:5px 0 0 5px;'>
				<div>房间描述：</div>
				<textarea id="houseDesc" style="margin:5px 0 0 0;width:900px;height:50px;" require="require" clear="clear">
					*********************************************描述50-500字符*********************************************
				</textarea>
			</div>
		</div>
	...
	<div id="updatePushHouseDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style='margin:5px 0 0 5px;float:left;'>
			<div id="bindAddress2" clear="clear"></div>
	...
	<script src="js/fg.zzyPushHouse.js"></script>
