...
<head>
	...
	<script src="js/school_office.js"></script>
</head>
<body>
	...
	<div>
		<div style="margin:5px 0 0 0; float:left;">
			...
			plain="true" id="addVirtualButton" onclick="addVirtual()">添加办公室</a>
		</div>
		<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-house-edit"
			plain="true" id="updateVirtualButton" onclick="updateVirtual()">修改办公室</a>
		</div>
		<div style="margin:5px 0 0 5px; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-zukeyixiangrenguanli"
			   plain="true" id="associatedPersonnelButton" onclick="officeAssociatedUsers(2)">教师授权</a>
		</div>
		<div style="margin:5px 0 0 5px; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-add"
			   plain="true" id="addScenarioButton" onclick="openSceneWindow(2)">添加情景</a>
		</div>
		<%--<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-add-house"
		...
		<div style="margin:5px 0 5px 5px; float:left; color:black;">
			<label for="searchVirtualName">办公室名称</label>
		...
		<div style="margin:5px 0 5px 5px; float:left; color:black;">
			<label for="searchVirtualState">办公室状态</label>
...
<%--				<option value="停用">停用</option>--%>
	...
	<div style="width:100%;">
		<table id="virtualDataGrid" style="width:100%; height:527px; table-layout:fixed; overflow:hidden;"
			...
			<thead>
				<tr>
					<th field="keyAdministrator" width="15" align="center">办公室名称</th>
...
<%--					<a class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="bindDevice_office()">绑定设备</a>--%>
	...
	<div id="addVirtualDlg" class="easyui-dialog" style="padding:6px;" data-options="closed:true">
		<fieldset>
			<legend>
				<span style="font-size:12px; font-family:'Microsoft YaHei'; color:#50B4D2;">办公室信息</span>
			</legend>
...
<%--					<option value="停用">停用</option>--%>
	...
	<div id="officeAssociatedUsersDig"style="padding:6px" class="easyui-dialog" data-options="closed:true">
		...
		<div style="padding:2px 0 0 0;">
			<div style="margin-top:2px;padding:5px 0 0 5px;width:20%;float: left;">
