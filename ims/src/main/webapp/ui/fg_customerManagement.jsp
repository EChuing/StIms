...
<body>
	...
	<div id="contract" style="padding:6px" class="easyui-dialog" data-options="closed:true">
		...
		<fieldset>
			...
			<div style="margin: 5px 0 0 0;">
				<div style="margin:0 0 5px 12px;color:black;font-size:13px;float:left;">
					合同期限：<input class="Wdate" id="addHsBegin" style="width: 100px;border-color:#a9a9a9;"clear="clear" require="require"
			...
			<div style="margin: 5px 0 0 0;">
				...
				<div style="margin:0 0 5px 30px;color:black;font-size:13px;float:left;">
					电话号码：<input style="width:200px;" id="bankAccount_phone">
				</div>
			</div>
			<div style="height: 10px;clear: both"></div>
			<div style="margin: 5px 0 0 0;">
				<div style="margin:0 0 5px 12px;color:black;font-size:13px;float:left;">
					身份证号：<input style="width:100px;" id="bankAccount_remarks" onkeyup="">
				</div>
				<div style="margin:0 0 5px 32px;color:black;font-size:13px;float:left;">
					合同编号：<input id="contractNum" style="width: 150px;" clear="clear"
	...
	<script src="js/fg_customerManagement.js"></script>
