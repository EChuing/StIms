...
<div style="width:35%;height:425px;float:left;margin:0 0 0 20px;border:1px solid #337ab7;border-radius:5px">
    ...
    <div id="newOrderDataGrid" style="width:97%;height:325px;margin:10px auto">
        <table id="newOrderDg" style="width:100%;height:100%;table-layout:fixed;overflow:hidden;"
...
<div style="width:60%;height:425px;float:left;margin:0 0 0 20px;border:1px solid #337ab7;border-radius:5px">
    ...
    <input id="pid" type="hidden"></input>
    ...
    <div style="float:left;margin:10px 0 0 10px">
        实付金额 :<input type="number" data-type="money" id="pcgbActualSpending"
                     style="width:99px;margin:0 0 0 5px"></input>
    </div>
    ...
    <div id="orderGoodsDataGrid" style="width:97%;height:150px;margin:10px 10px 0 10px">
        <table id="orderGoodsDg" style="width:100%;height:150px;table-layout:fixed;overflow:hidden;"
               class="easyui-datagrid"
               data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
            <thead>
            <tr>
    ...
    <div style="text-align:center">
        <div id="accept" style="float:left;display:none">
            <button type="button" class="btn btn-success" style="margin:25px 0 5px 25px;width:160px;"
                    onclick="dealWithOrder(1)">接单
            </button>
        </div>
        <div id="send" style="float:left;display:none">
            <div style="color:black;margin:31px 0 5px 25px;font-size:13px;float:left;">
                配送人：<input id="searchOrderManagerShowUserInfo" class="choose_user_button" doFlag="searchOrderManager"
                           doFun=""
                           style="width:120px;cursor: pointer;" type="text" readonly="readonly" clear="clear"
                           require="require">
            ...
            <div style="float:left;">
                <button type="button" class="btn btn-success" style="margin:25px 0 5px 25px;width:160px;"
                        onclick="dealWithOrder(2)">配送
                </button>
            </div>
        </div>
        <div id="sendMail" style="float:left;display:none">
            <button type="button" class="btn btn-success" style="margin:25px 0 5px 25px;width:160px;"
                    onclick="dealWithOrder(5)">发货
            </button>
        </div>
        <div id="finish" style="float:left;display:none;margin: 0 0 0 35px">
            <button type="button" class="btn btn-success" id="" style="margin:25px 0 5px 25px;width:160px;"
                    onclick="dealWithOrder(4)">结单
            </button>
        </div>
        <div id="retreat" style="float:left;display:none;margin: 0 0 0 35px">
            <button type="button" class="btn btn-success" id="" style="margin:25px 0 5px 25px;width:160px;"
                    onclick="dealWithOrder(3)">退单
            </button>
        </div>
...
<div id="undoneOrderDataGrid" style="width:100%;height:30%;margin:1% 0 0 0">
    <table id="undoneOrderDg" style="width:100%;height:300px;table-layout:fixed;overflow:hidden;"
           class="easyui-datagrid"
           data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
        <thead>
        <tr>
...
<div id="sceneSellDlg" class="easyui-dialog" data-options="closed:true">
    <div style="float:left;margin:2% 0 0 8%">
        <select id="selectType" style="width:150px;height:35px;border-radius:5px" choose="choose" require="require"
                onchange="selectType()">
    ...
    <div style="float:left;margin:2% 0 0 2%" id="searchSN">
        <input id="searchSNInput" list="SNGoodsList" style="width:480px;height:35px;border-radius:5px"
               placeholder="请输入 商品SN码"/>
    </div>
    <div style="float:left;margin:2% 0 0 2%" id="search">
        <input id="searchInput" list="goodsList" style="width:480px;height:35px;border-radius:5px"
               placeholder="请输入 商品编号/商品名称"/>
    </div>
    <div style="float:left;margin:2% 0 0 2%">
        <button type="button" onclick="addGoods()" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;">添加
        </button>
    </div>
    <div style="clear:both"></div>
    <div id="sceneGoodsDataGrid" style="width:90%;margin:1% 0 0 5%">
        <table id="sceneGoodsDg" style="width:100%;height:300px;table-layout:fixed;overflow:hidden;"
               class="easyui-datagrid"
               data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
            <thead>
            <tr>
    ...
    <div style="clear:both"></div>
    <div style="margin:2% 0 0 40%;text-align:center">
        <div>
    ...
    <div style="clear:both"></div>
    <div style="text-align:center;">
        <!-- <div style="float:left;margin:2% 0 0 20%">
            <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;">挂单</button>
        </div>
        <div style="float:left;margin:2% 0 0 2%">
            <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;">取单</button>
        </div> -->
        <div style="float:left;margin:2% 0 0 25%">
            <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(1,1)">
                现金收银
            </button>
        </div>
        <div style="float:left;margin:2% 0 0 2%">
            <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(2,1)">
                扫码收银
            </button>
        </div>
        <div style="float:left;margin:2% 0 0 2%">
            <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(3,1)">
                台卡收银
            </button>
        </div>
    </div>
...
<div id="openCashDlg" class="easyui-dialog" data-options="closed:true" style="text-align:center">
    ...
    <div class="cash qrCode" style="margin:5% 0 5% 0">
        <input id="moneyInput" type="number" onkeyup="changMoney()"
               style="width:300px;height:35px;border-radius:5px;font-size:20px;text-align:center" placeholder=""/>
    </div>
    <div style="clear:both"></div>
    ...
    <%--<div id="cashButton" class="cash" style="margin:23% 0 0 0">
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="doCash(1)">现金收银
        </button>
    </div>
    <div id="qrcodeButton" class="qrCode" style="margin:23% 0 0 0">
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="doCash(2)">扫码收银
        </button>
    </div>
    <div id="cardButton" class="qrCodeCustomer" style="margin:23% 0 0 0">
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="doCash(3)">台卡收银
        </button>
    </div>--%>
</div>
...
<div id="salesRecords" class="easyui-dialog" data-options="closed:true" style="text-align:center">
    ...
    <div id="orderDataGrid" style="width:100%;height:80%;margin:10px 0 0 0">
        <table id="orderDg" style="width:100%;height:402px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
               data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
            <thead>
            <tr>
                <th field="cgbOrderNum" width="20" align="center">订单号</th>
        ...
        <div id="orderPageDiv" style="margin-top:5px;width:100%;text-align:center;"></div>
    </div>
</div>
...
<div id="orderDetailDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
    ...
    <div style="clear:both"></div>
    <div id="orderGoodsDataGrid" style="width:97%;height:150px;margin:10px 10px 0 10px">
        <table id="salesGoodsDg" style="width:100%;height:150px;table-layout:fixed;overflow:hidden;"
               class="easyui-datagrid"
               data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
            <thead>
                <tr>
                    ...
                    <th field="cgsOriginalPrice" width="10" align="center">原价</th>
                    <th field="cgsCurrentPrice" width="10" align="center">现价</th>
                    <th field="preferential" width="9" align="center">优惠标签</th>
                    <th field="sellWell" width="9" align="center">热销标签</th>
                    <th field="cgSnType" width="9" align="center">SN类商品</th>
                    <th field="exchangeGoodsButton" width="10" align="center" formatter="exchangeGoodsButton">换货</th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <center style="margin:10px 0 0 0;">
        <a class="easyui-linkbutton" iconcls="icon-up"
           onclick="lastOrNext(0, 'orderDetail_index', 'orderDg', 'orderDetailDlg', 'openOrderDetail(row)')">上一条</a>
        <a class="easyui-linkbutton" iconcls="icon-cancel" onclick="$('#orderDetailDlg').dialog('close')">关闭</a>
        <a id="refundOrder" class="easyui-linkbutton" iconcls="icon-tuikuan" style="display:none"
           onclick="refundOrder()">退单</a>
        <a class="easyui-linkbutton" iconcls="icon-down"
           onclick="lastOrNext(1, 'orderDetail_index', 'orderDg', 'orderDetailDlg', 'openOrderDetail(row)')">下一条</a>
    </center>
</div>
...
<div id="sendMailDlg" class="easyui-dialog" data-options="closed:true" style="text-align:center">
    <div style="margin:5% 0 5% 0">
        快递公司 ：<input id="mailNameInput"
                     style="width:300px;height:35px;border-radius:5px;font-size:20px;text-align:center" placeholder=""/>
    </div>
    <div style="margin:5% 0 5% 0">
        快递单号：<input id="mailNumInput" style="width:300px;height:35px;border-radius:5px;font-size:20px;text-align:center"
                    placeholder=""/>
    </div>
    <div style="float:left;margin:2% 0 0 33%">
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="operating(5)">
            发货
        </button>
    </div>
</div>
...
<%--换货窗口--%>
<div id="exchangeGoodsDlg" class="easyui-dialog" data-options="closed:true">
    <input id="goodsSellData" type="hidden" />
    <div style="float:left;margin:5px 0 0 5px">
        类目 : <select id="cgcCategoryName" onchange="queryGoods()" clear="clear"></select>
    </div>
    <div style="float:left;margin:5px 0 0 5px">
        名称 : <input id="cgName" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryGoods()')" clear="clear" />
    </div>
    <div style="float:left;margin:5px 0 0 5px">
        现价 : <input id="cgCurrentPrice" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryGoods()')" clear="clear" />
    </div>
    <div style="float:left;margin:5px 0 0 5px">
        原价 : <input id="cgOriginalPrice" onkeyup="searchOnkeyup(this.id, '_indexNum[0] = 0;queryGoods()')" clear="clear" />
    </div>
    <div style="clear:both;"></div>
    <div style="margin-top:5px;text-align:center">
        <table id="exchangeGoodsTable" style="width:100%;height:280px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid" data-options="singleSelect:true, autoRowHeight:false, fitColumns:true,
            scrollbarSize:0,checkOnSelect: false, selectOnCheck: false,onClickRow:onClickRow2">
            <thead>
                <tr>
                    ...
                    <th field="cgCurrentPrice" width="10" align="center">现价</th>
                    <th field="cgOriginalPrice" width="10" align="center">原价</th>
                    <th field="cgNum" width="10" align="center" formatter="changeColorRed">商品数量</th>
                    <th field="num" width="10" align="center" data-options="editor:{type:'textbox',options:{
						precision:0}}">出售数量</th>
                </tr>
            </thead>
        </table>
    ...
    <div style="margin:5px 5px 0 0;float:right">
        <a href="#" style="color:red" onclick="calculatedAmount()">计算差价</a>
    </div>
    <div id="totalMoneyDiv" style="margin:5px 5px 0 0;float:right;">
        应收 : <input id="totalMoney" clear="clear" readonly="readonly" />
    </div>
    <div id="exchangeGoodsDiv" style="margin:5px 5px 0 0;float:right;">
        被换货的商品数量 : <input id="exchangeGoodsNum" clear="clear" style="width:110px;" onkeyup="checkNumber()" />
    </div>
    <div style="clear:both"></div>
    <div id="collectionDiv" style="margin-top:10px;text-align:center;display:none">
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(1,2)">
            现金收银
        </button>
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(2,2)">
            扫码收银
        </button>
        <button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="openCash(3,2)">
            台卡收银
        </button>
    </div>
    <div id="noCollectionDiv" style="margin-top:10px;text-align:center;display:none">
        <a id="doExchangeGoods" class="easyui-linkbutton" iconcls="icon-save" onclick="doChangeGoods(4)">确定</a>
        <a class="easyui-linkbutton" iconcls="icon-cancel" onclick="$('#exchangeGoodsDlg').dialog('close')">取消</a>
    </div>
</div>

<script src="js/fg.public.js"></script>
<script src="js/fg_shopOrder.js"></script>
</body>
</html>