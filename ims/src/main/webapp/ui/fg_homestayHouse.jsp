...
<body>
	...
	<div>
		...
		<div id="shortRentHouse" style="width:100%;margin:10px 0 0 0">
			<table id="shortRentHouseTable" style="width:100%;height:527px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th field="hsDailyRent" width="15" align="center">日租价格</th>
						<th field="hsHotDailyRent" width="15" align="center">高峰价格</th>
						<th field="hsResidentiality" width="10" align="center">可住人数</th>
						<th field="hsRoomType" width="15" align="center">短租房型</th>
	...
	<div id="addGuestRoomsDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div id="addHsNoPaper" style='float:left'>
			<div style='margin:10px 0 0 24px;float:left'>
				<lable style="display:inline-block;"><span class="require">*</span>省份:</lable>
				<input id="shortRentProvince" style="width:120px;" readonly="readonly" clear="clear1"></select>
			</div>
			<div style='margin:10px 0 0 26px;float:left'>
				<lable style="display:inline-block;"><span class="require">*</span>城市:</lable>
				<input id="shortRentCity" style="width:120px;" readonly="readonly" clear="clear1">
			</div>
			<div style='margin:10px 0 0 36px;float:left'>
				<lable style="display:inline-block;"><span class="require" >*</span>城区:</lable>
				<select id="addShortRentDistrict" style="width: 120px;" require="require" onchange="noZoneLink()">
					<option></option>
				</select> 
				<input type="hidden" id="addShortRentZone" clear="clear">
				<input type="hidden" id="addShortRentStreet" clear="clear">
				<lable style="display:inline-block;"><span class="require">*</span>门店名称:</lable>
				<input type="text" id=buildingName style="width: 120px;" clear="clear" require="require"
				...
				<div id="buildingNameDiv" style="margin-left:246px;height:150px;width:120px;display:none;position : absolute; z-index : -1;background-color: #fff">
					<select id="addNoTrusteeshipBuildingName" multiple="multiple" 
						style="height:150px;width:120px;" onchange="noStreeLink()">
						<option></option>
					</select>
				</div>
			</div>
			<div style="clear:both"></div>
			<div style="margin:10px 0 0 24px;float:left">
				<lable style="display:inline-block;"><span class="require">*</span>房号:</lable>
				<input id="addShortRentDoorplateno" style="width:120px" clear="clear" require="require" >
			</div>
			<div style="float:left;margin:10px 0 0 26px" >
				<lable style="display:inline-block;"> <span class="require">*</span>户型:</lable>
				<select class="sectionType" id="addHsSectionType" style="width: 120px;" choose="choose" require="require" clear="clear">
					<option></option>
				</select>
			</div>
			<div style="float:left;margin:10px 0 0 12px">
				<lable style="display:inline-block;"><span class="require">*</span>可住人数:</lable>
				<input id="addHsResidentiality" type="number" style="width:120px;" clear="clear" require="require"/>
			</div>
			<div style="float:left;margin:10px 0 0 4px;">
				<lable style="display:inline-block;"><span class="require">*</span>短租房型:</lable> 
				<select id="addShortHouseType" style="width:120px;">
				</select>
			</div>
			<div style="clear:both"></div>
			<div style="float:left;margin:10px 0 0 12px">
				<lable style="display:inline-block;"><span class="require">*</span>日房价:</lable>
				<input id="addHsDailyRent" type="number" style="width:120px;" clear="clear" require="require"/>
			</div>
			<div style="float:left;margin:10px 0 0 2px">
				<lable style="display:inline-block;"><span class="require">*</span>高峰价格:</lable>
				<input id="addHsHotDailyRent" type="number" style="width:120px;" clear="clear" require="require"/>
			</div>
			<div style="float:left;margin:10px 0 0 0">
				<lable style="display:inline-block;"><span class="require">*</span>钟点房价格:</lable>
				<input id="addHsTimePrice" type="number" style="width:120px;" clear="clear" require="require"/>
			</div>
		</div>
		<div style="clear:both"></div>
	...
	<jsp:include page="/ui/fg_homestayHouseDetails.jsp"></jsp:include>
	<script src="js/upload.js"></script>
	<script src="js/fg.public.js"></script>
	<script src="js/fg_homestayHouse.js"></script>
