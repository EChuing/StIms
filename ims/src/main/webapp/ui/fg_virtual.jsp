...
<head>
	...
	<script src="js/fg.virtual.js"></script>
</head>
<body>
	...
	<div>
		<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-add-house"
				plain="true" id="addVirtualButton" onclick="addVirtual()">录入项目</a>
		</div>
		<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-house-edit"
				plain="true" id="updateVirtualButton" onclick="updateVirtual()">修改项目</a>
		</div>
		...
		<div style="margin:5px 0 5px 5px; float:left; color:black;">
			<label for="searchVirtualState">项目状态</label>
	...
	<div style="width:100%;">
		<table id="virtualDataGrid" style="width:100%; height:277px; table-layout:fixed; overflow:hidden;"
			...
			<thead>
				<tr>
					<th field="keyAdministrator" width="10" align="center">项目名称</th>
					<th field="addDoorplateno" width="10" align="center">备注描述</th>
	...
	<div id="addVirtualDlg" class="easyui-dialog" style="padding:6px;" data-options="closed:true">
		<fieldset>
			<legend>
				<span style="font-size:12px; font-family:'Microsoft YaHei'; color:#50B4D2;">项目信息</span>
			</legend>
			<div style="margin:5px 0 0 2px; float:left; color:black;" id="virtualTypeDiv">
				<label for="virtualState">项目状态</label>
			...
			<div style="margin:5px 0 0 14px; float:left;display:none;">
				...
				<input style="width:300px;" id="virtualType" placeholder="项目" >
			</div>
			...
			<div style="display:none;">
				...
				楼盘ID<input id="dictId">
				市<input id="virtualCity">
				城区/县<input id="virtualDistrict">
				片区<input id="virtualZone">
				地址<input id="virtualRoad">
				小区<input id="virtualCommunity">
				楼栋<input id="virtualBuilding">
			</div>
			<div style="clear:both"></div>
					...
					<table class="xwtable1" style="width:100%;margin-top:10px;">
						<tbody>
							<tr>
								...
								<td>项目分类：</td>
								<td><span id="readOnlyVirtualaddCommunity"></span></td>
								<td>项目名称：</td>
							...
							<tr>
								<td>初期金额：</td>
								<td><span id="readOnlyVirtualhouseSellingPrice"></span></td>
								<td>校准金额：</td>
								<td><span id="readOnlyVirtualunitPriceRent"></span></td>
								<td>项目余额：</td>
								<td><span id="readOnlyVirtualunitPriceSell"></span></td>
							</tr>
							<tr>
								<td>项目备注：</td>
								<td colspan="5"><span
