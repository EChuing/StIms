...
<head>
	...
	<script src="js/fg_officeAreaManagement.js"></script>
	<style>
		table td {
...
<body>
	...
	<div>
		<div style="margin:5px 0 0 0; float:left;">
			...
			plain="true" id="addVirtualButton" onclick="addVirtual()">添加公区</a>
		</div>
		<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-house-edit"
			plain="true" id="updateVirtualButton" onclick="updateVirtual()">修改公区</a>
		</div>
		<div style="margin:5px 0 0 0; float:left;">
			<a class="easyui-linkbutton" iconCls="icon-add-house"
		...
		<div style="margin:5px 0 5px 5px; float:left; color:black;">
			<label for="searchVirtualState">公区状态</label>
	...
	<div style="width:100%;">
		<table id="virtualDataGrid" style="width:100%; height:527px; table-layout:fixed; overflow:hidden;"
			...
			<thead>
				<tr>
					<th field="keyAdministrator" width="15" align="center">公区名称</th>
		...
		<div id="operationWindow" class="easyui-tabs">
			...
			<div title="耗材管理" tabindex="1">
				...
				<table id="suppliesInformation" class="easyui-datagrid" style="width:100%;height:402px;table-layout:fixed;overflow:hidden;"
					...
					<thead>
						<tr>
							<th width="20" align="center" field="keyAdministrator">公区</th>
	...
	<div id="addVirtualDlg" class="easyui-dialog" style="padding:6px;" data-options="closed:true">
		<fieldset>
			<legend>
				<span style="font-size:12px; font-family:'Microsoft YaHei'; color:#50B4D2;">公区信息</span>
			</legend>
			<div style="margin:5px 0 0 2px; float:left; color:black;" id="virtualTypeDiv">
				<label for="virtualState">公区状态</label>
			...
			<div style="margin:5px 0 0 14px; float:left;display:none;">
				...
				<input style="width:300px;" id="virtualType" value="公区" placeholder="公区" readonly="readonly"></input>
			</div>
	...
	<div id="moveAssetDlg" style="padding:6px" class="easyui-dialog" data-options="closed:true">
		...
		<div style="margin:10px 0 5px 5px;">
			迁入公区地址：<input id="move_to_asset_choseHouse" readonly="readonly" onclick="choseHouse(1,2)" 
				style="width:400px" placeholder="单击选择公区，必选"  must="must">
        ...
        <div class="clearfix">
            <div style="margin:5px 0 5px 30px;float:left;">迁移原因：</div>
