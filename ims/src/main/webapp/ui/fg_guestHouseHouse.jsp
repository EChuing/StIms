...
<div id="addGuestRoomsDlg" class="easyui-dialog" data-options="closed:true">
    ...
    <div id="addHsNoPaper" style='float:left'>
        ...
        <div style='margin:10px 0 0 36px;float:left'>
            ...
            <lable style="display:inline-block;"><span class="require">*</span>小区名称:</lable>
        ...
        <div style="float:left;margin:10px 0 0 2px">
            <lable style="display:inline-block;"><span class="require">*</span>房屋类型:</lable>
            <select id="addShortHouseType"  style="width:120px;" clear="clear" require="require">
            </select>
        </div>
    </div>
    <div style="clear:both"></div>
...
<script src="js/fg_guestHouseHouse.js"></script>
