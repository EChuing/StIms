...
<div>
	<div style="margin:10px 0 15px 10px;float: left ">
		<div style="margin:0 0 5px 5px;float:left;">
			姓名：<input id="searchPopulationName" onkeyup="searchOnkeyup(this.id, 'getListContract(1, 0)')" style="width:80px">
		</div>
		<div style="margin:0 0 5px 5px;float:left;">
			电话：<input id="searchPopulationPhone" onkeyup="searchOnkeyup(this.id, 'getListContract(1, 0)')" style="width:100px">
		</div>
		<div style="margin:0 0 5px 5px;float:left;">
			身份证：<input id="searchPopulationIdCard" onkeyup="searchOnkeyup(this.id, 'getListContract(1, 0)')" style="width:80px">
		</div>
		<div style="margin:0 0 5px 5px;float:left;">
		...
		<div style="margin:0 0 5px 5px;float:left;">
			状态：<select id="customerState" onchange="getListContract(1,0);" style="width:80px">
				<option value="">全部</option>
				<option value="已住">已住</option>
				<option value="离开">离开</option>
			</select>
		</div>
		<div style="margin:0 0 5px 5px;padding:0 0 5px 5px;color:black;float:left;">
		入住时间：<input id="searchHouseStart" style="margin:0 5px 0 0;width:100px" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'searchHouseEnd\',{d:0});}',dateFmt:'yyyy-MM-dd',autoPickDate:true,dchanging:getListContract(1,0)})">
	...
	<jsp:include page="/ui/fg_shortRentOrderDetails.jsp"></jsp:include> 
	<script src="js/fg.public.js"></script>
	<script src="js/fg_shortRentCustomer.js"></script>
</body>
</html>