...
<body>
		...
		<div style="margin:5px 0 0 5px;">
			...
			<div id="vipHidden">
				<div style='margin:10px 0 0 5px;float: left;'>
					联系人: <input id="jcuContactsPeople" clear="clear">
				</div>
				<div style='margin:10px 0 0 10px;float: left;'>
					联系电话: <input id="jcuTelephone" clear="clear">
				</div>
				<div style='margin:10px 0 0 10px;float: left;'>
					挂账额度: <input id="jcuMaxCredit" data-type="money-positive" clear="clear">
				</div>
			</div>
			<div style="clear:both"></div>
			<div style='margin:10px 0 0 5px;float: left;'>
	...
	<script src="js/fg_shortRentChannel.js"></script>
</body>
</html>