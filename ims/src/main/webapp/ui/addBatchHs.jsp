...
<body>
	...
	<div id="addBatchHsDlg" style="padding: 6px;">
		...
		<div class="addBatchHsSteps">
			<div class="step addBatchHsStep1" >
				<div style="min-height: 320px; padding: 5px 0 0 0;">
					<div class="hsFieldset">
						
						<div style='margin: 10px 0 0 12px;'>
							<lable style="display:inline-block;width:60px;margin-left: 10px"> <span
								class="require">*</span>省份：</lable>
							<input type="text" id="province" style="width: 100px;"clear="clear" require="require" disabled="disabled">
							
							<lable style="display:inline-block;width:60px;margin-left: 10px"> <span class="require">*</span>城市：</lable>
							<select id="addNoTrusteeshipCity" style="width: 100px;" disabled="disabled"></select>
							
							<lable style="display:inline-block;width:60px;margin-left: 10px;margin: 0 0 0 24px;">
							 	<span class="require">*</span>城区：
							 </lable>
							<select id="addNoTrusteeshipDistrict" style="width: 150px;margin: 0 0 0 -4px;" require="require"
								onchange="noZoneLink()">
								<option></option>
							</select>

							<lable style="display:inline-block;width:60px;margin-left: 34px"> <span class="require">*</span>片区：</lable>
							<input type="text" required="required" id="addNoTrusteeshipZone" style="width: 100px;margin-left: -4px;">

						</div>
					</div>
					<div id="owner" style="margin: 10px 0 0 12px;">
						<lable style="display:inline-block;width:60px;margin-left: 10px"> <span class="require">*</span>姓名：</lable>
						<input id="addHsLandlordName" style="width: 100px;" clear="clear" require="require">
						
						<lable style="display:inline-block;width:60px;margin-left: 10px"> <span class="require">*</span>电话：</lable>
						<input id="addHsLandlordPhoneNum" style="width: 100px;" clear="clear" require="require">
					
						<lable style="display:inline-block;width:80px;"> <span class="require">*</span>证件号码：</lable>
						<input id="addHsLandlordIdcard" style="width: 150px;" clear="clear" require="require">

						<lable style="display:inline-block;width:80px;margin-left: 10px"> <span class="require">*</span>户籍地址：</lable>
						<input id="addHsLandlordIdcardAddress" style="width: 100px;" clear="clear" require="require">

						<input id="addHsLandlordBirth" hidden="hidden">
						<input id="addHsLandlordSex" hidden="hidden">
						<input id="addHsLandlordNation" hidden="hidden">
						<%--<input id="addHsLandlordIdcardAddress" hidden="hidden">--%>
						<input id="addHsLandlordImsphoto" hidden="hidden">
						
						<a id="addLandlordID" class="easyui-linkbutton" style="margin:0 5px 0 10px;" onclick="new Device().startFun(this.id)">读取身份证</a>
					</div>
					<div style="margin: 10px 0 0 0;">
						<lable style="display:inline-block;width:90px;"> <span class="require">*</span>合同期限：</lable>
						<input class="Wdate" id="addHsBegin" style="width: 133px;margin: 0 0 0 -8px" clear="clear" require="require"
							onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'addHsEnd\',{d:-1});}',dateFmt:'yyyy-MM-dd',autoPickDate:true,dchanging:changeAddHsDate()})">
						- <input class="Wdate" id="addHsEnd" style="width: 133px" clear="clear" require="require"
					...
					<div id="priceLadder" style="display: none;">
						<fieldset>
				...
				<div class="btn-bar" style="margin: 10px 10px 10px 0; text-align: center;">
					...
					<a class="easyui-linkbutton" style="margin: 0 5px;" onclick="parent.$('#addBatchHomeDlg').dialog('close');">取消</a>
				</div>
			</div>
		</div>
		<div class="addBatchHsSteps">
			<div class="step addBatchHsStep2">
				<div style="min-height:320px;padding:5px 0 0 0;">
				...
				<div class="btn-bar" style="margin:10px 10px 10px 0;text-align:center;">
					<a class="easyui-linkbutton" style="margin:0 5px;" onclick="gotoStep('addBatchHs', 1);">上一步</a>
		...
		<div class="addBatchHsSteps">
			<div class="step addBatchHsStep3">
				...
				<div class="btn-bar" style="margin:10px 10px 10px 0;text-align:center;">
				<a class="easyui-linkbutton" style="margin:0 5px;" onclick="gotoStep('addBatchHs', 2);$('#centralizedApartmentParameterDg2').datagrid('loadData',[]);">上一步</a>
		...
		<div class="addBatchHsSteps">
			<div class="step addBatchHsStep4">
				<div style="min-height:320px;padding:5px 0 0 0;">
					<div style="padding:10px 0 0 5px;width:98%;">
				...
				<div class="btn-bar" style="margin:10px 10px 10px 0;text-align:center;">
					<a class="easyui-linkbutton" style="margin:0 5px;" onclick="gotoStep('addBatchHs', 3);">上一步</a>
					<a class="easyui-linkbutton" style="margin:0 5px;" onclick="doAddTrusteeship()">保存</a>
					<a class="easyui-linkbutton" style="margin:0 5px;" onclick="parent.$('#addBatchHomeDlg').dialog('close');">取消</a>
				</div>
			</div>
		</div>
	...
	<script src="js/addBatchHs.js"></script>
