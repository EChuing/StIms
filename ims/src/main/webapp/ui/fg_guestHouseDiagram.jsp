    ...
    <div style="float:left;width:300px">
        ...
        <div style="margin:10px 0 0 18px;float:left;" id="deviceDiv ">
            <center id="checkOutDlgButton1" style="margin:5px 0 0 2px;float:left;background-color: white;">
                ...
                <div style="margin:0 0 0 10px;float:left;"id="lightDiv" title="该房尚未绑定相关设备">
                    <a id="light" class="easyui-linkbutton" plain="true"><img style="height:70px;width:70px" src="img/ic_dt_c_light_gray.png" /></a>
                </div>
...
<div id="checkOutDiv" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true">
    ...
    <center id="refundType0" style="display:none;text-align:center;margin:10px 0 0 0;" class="hiddenButton">
        <button id="normalCheckout0" class="btn btn-success hiddenButton" type="button" style="display:none" onclick="checkOutShortRent(0,5)">现金退款</button>
        <button id="normalCheckout1" class="btn btn-success hiddenButton" type="button" style="display:none" onclick="checkOutShortRent(0,4)">原路返还</button>
    </center>
    <center id="refundType1" style="text-align:center;display:none;margin:10px 0 0 0" class="hiddenButton">
        <button id="advanceCheckoutType0" class="btn btn-success hiddenButton" type="button" style="display:none" onclick="checkOutShortRent(1,5)">现金退款</button>
        <button id="advanceCheckoutType1" class="btn btn-success hiddenButton" type="button" style="display:none" onclick="checkOutShortRent(1,4)">原路返还</button>
    </center>
    <div id="doMoveOut0" style="dispaly:none;text-align:center" class="hiddenButton">
        <button type="button" class="openCashBtn1 btn btn-success" style="float:left;margin:10px 0 5px 75px;width:120px;" onclick="openCash(1,3)">现金收银</button>
        <button type="button" class="openCashBtn2 btn btn-success" style="float:left;margin:10px 0 5px 20px;width:120px;" onclick="openCash(2,3)">扫码收银</button>
        <button type="button" class="openCashBtn3 btn btn-success" style="float:left;margin:10px 0 5px 20px;width:120px;" onclick="openCash(3,3)">台卡收银</button>
    </div>
    <div id="doMoveOut1" style="dispaly:none;text-align:center" class="hiddenButton">
        <button type="button" class="openCashBtn1 btn btn-success" style="float:left;margin:10px 0 5px 75px;width:120px;" onclick="openCash(1,4)">现金收银</button>
        <button type="button" class="openCashBtn2 btn btn-success" style="float:left;margin:10px 0 5px 20px;width:120px;" onclick="openCash(2,4)">扫码收银</button>
        <button type="button" class="openCashBtn3 btn btn-success" style="float:left;margin:10px 0 5px 20px;width:120px;" onclick="openCash(3,4)">台卡收银</button>
    </div>
</div>
...
<div id="changeHouseDlg" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true">
    ...
    <div class="hiddenClass" id="changHouseOpenClean" style="display:none;text-align:center">
        <button type="button" class="openCashBtn1 btn btn-success" style="float:left;margin:20px 0 5px 30px;width:120px;" onclick="openCash(1,6)">现金收银</button>
        <button type="button" class="openCashBtn2 btn btn-success" style="float:left;margin:20px 0 5px 20px;width:120px;" onclick="openCash(2,6)">扫码收银</button>
        <button type="button" class="openCashBtn3 btn btn-success" style="float:left;margin:20px 0 5px 20px;width:120px;" onclick="openCash(3,6)">台卡收银</button>
    </div>
    <div class="hiddenClass" id="directChangeHouse" style="display:none;text-align:center">
        <button type="button" class="openCashBtn1 btn btn-success" style="float:left;margin:20px 0 5px 30px;width:120px;" onclick="openCash(1,7)">现金收银</button>
        <button type="button" class="openCashBtn2 btn btn-success" style="float:left;margin:20px 0 5px 20px;width:120px;" onclick="openCash(2,7)">扫码收银</button>
        <button type="button" class="openCashBtn3 btn btn-success" style="float:left;margin:20px 0 5px 20px;width:120px;" onclick="openCash(3,7)">台卡收银</button>
    </div>
</div>
...
<div id="renewDlg" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true">
    ...
    <div id="doRenew" style="dispaly:flex;text-align:center">
        <button type="button" class="openCashBtn1 btn btn-success" style="margin:20px 10px 0 0px;width:120px;" onclick="openCash(1,5)">现金收银</button>
        <button type="button" class="openCashBtn2 btn btn-success" style="margin:20px 10px 0 0px;width:120px;" onclick="openCash(2,5)">扫码收银</button>
        <button type="button" class="openCashBtn3 btn btn-success" style="margin:20px 10px 0 0px;width:120px;" onclick="openCash(3,5)">台卡收银</button>
    </div>
</div>
<!-- 收款页面 -->
...
</div><div id="checkInDlg1" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true,buttons:'#bottomButton'">
    <div id="bottomButton">
    ...
    <div style="float:left;width:320px">
        ...
        <div style="margin:20px 0 0 0;">
            ...
            <div id="checkIn" style="float:left;width:38%;display:none;text-align:center">
                <button type="button" class="openCashBtn1 btn btn-success" style="margin:60px 0 0 110px;width:120px;" onclick="doCheckIn(4)">办理入住</button>
            </div>
            <div id="sceneButton" style="float:left;width:38%;display:none;text-align:center">
                <button type="button" class="openCashBtn1 btn btn-success" style="margin:5px 0 5px 0px;width:120px;" onclick="openCash(1,1)">现金收银</button>
                <button type="button" class="openCashBtn2 btn btn-success" style="margin:10px 0 5px 0px;width:120px;" onclick="openCash(2,1)">扫码收银</button>
                <button type="button" class="openCashBtn3 btn btn-success" style="margin:10px 0 5px 0px;width:120px;" onclick="openCash(3,1)">台卡收银</button>
                <button type="button" class="openCashBtn4 btn btn-success" style="margin:10px 0 5px 0px;width:120px;display:none" onclick="canCheckIn(5)">挂账入住</button>
            </div>
            <!-- openCash -->
            <div id="retainButton" style="float:left;width:38%;display:none;text-align:center">
                <button type="button" class="openCashBtn1 btn btn-success" style="margin:5px 0 5px 0px;width:120px;" onclick="openCash(1,2)">现金收银</button>
                <button type="button" class="openCashBtn2 btn btn-success" style="margin:10px 0 5px 0px;width:120px;" onclick="openCash(2,2)">扫码收银</button>
                <button type="button" class="openCashBtn3 btn btn-success" style="margin:10px 0 5px 0px;width:120px;" onclick="openCash(3,2)">台卡收银</button>
                <button type="button" class="openCashBtn4 btn btn-success" style="margin:10px 0 5px 0px;width:120px;" onclick="doCheckIn(5)">挂账入住</button>
            </div>
...
<div id="addShortRentDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
    ...
    <div id="timeChoice" class="easyui-dialog" data-options="closed:true">
        ...
        <script src="js/fg_guestHouseHouseDetails.js"></script>
        <script src="js/fg_guestHouseDiagram.js"></script>
