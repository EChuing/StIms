...
<div id="chooseOperateDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
	...
	<div id="BrightnessDiv" style="margin:5px 0 0 35px;display: none;float: left" >
		...
		亮度：<input id="Brightness" value="00" class="easyui-slider" data-options="showTip:false,onChange: function(value){
	...
	<div id="ColorTemperatureDiv" style="margin:5px 0 0 35px; display: none;float:left;">
		...
		色温：<input id="ColorTemperature" value="00" class="easyui-slider"data-options="showTip:false,onChange: function(value){
...
<%--人脸操作窗口--%>
<div id="faceControl" style="padding:10px;" class="easyui-dialog" data-options="closed:true">
	<div style="width: auto;height: auto;margin: 10px 0 0 0">
		<div>
			<button require="require" onclick="tenantAuthorization()" id="faceControlButton1" type="button" class="btn btn-default" style="margin:0 0 5px 0;">租客授权</button>
			<%--<button require="require" onclick="" id="faceControlButton2" type="button" class="btn btn-default" style="margin:0 0 5px 0;">客户授权</button>--%>
			<button require="require" onclick="doRemoteOpen()" id="faceControlButton3" type="button" class="btn btn-default" style="margin:0 0 5px 0;">一键开锁</button>
			<%--<button require="require" onclick="" id="faceControlButton4" type="button" class="btn btn-default" style="margin:0 0 5px 0;">临时密码</button>--%>
			<button require="require" onclick="openPersonInfomationDiv()" id="faceControlButton5" type="button" class="btn btn-default" style="margin:0 0 5px 0;">识别记录</button>
		</div>
		</div>
	</div>
</div>
<%--租客授权窗口--%>
<div id="tenantAuthorization" style="padding:10px;" class="easyui-dialog" data-options="closed:true">
	<div style="margin: 5px 0 0 0">
		<div>
			<div style="float: left;margin: 0 0 0 0">
				房间号：<input type="text" id="roomNumberId" onkeyup="seldectTenant(1, 1)" >
			</div>
			<div style="float: left;margin: 0 0 0 5px">
				租客：<input type="text" id="tenantId" onkeyup="seldectTenant(1, 1)">
			</div>
			<div style="clear: both"></div>
		</div>
	</div>
	<div style="width: auto;height: auto;margin: 10px 0 0 0">
		<table id="tenantAuthorizationTable" style="width:100%;height:300px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
			   data-options="singleSelect:true, autoRowHeight:false, fitColumns:true, scrollbarSize:0,checkOnSelect: false, selectOnCheck: false">
			<thead>
				<tr>
					<th field="detailedAddress" width="20" align="center">地址</th>
					<th field="hrAddDoorplateno" width="15" align="center">房间号</th>
					<th field="renterPopName" width="15" align="center">租客</th>
					<th field="ifpPopId" width="10" align="center" formatter="formatAddPower">授权</th>
				</tr>
			</thead>
		</table>
		<!-- 分页 -->
		<div id="tenantAuthorizationPageDiv" style="width:99%"></div>
		<%--<div style="text-align: center;margin: 10px 0 0 0">
			<a class="easyui-linkbutton" iconcls="icon-cancel" onclick="$('#tenantAuthorization').dialog('close')">取消</a>
		</div>--%>
	</div>
</div>
<!-- 发卡窗口  -->
<div id="pushingCardDlg" style="padding:6px" class="easyui-dialog" data-options="closed:true">
	...
	<div style="clear:both"></div>
	<div style="text-align:center;">
		<a class="easyui-linkbutton" iconcls="icon-save" style="margin:40px 0 0 5px;" id="savePower" onclick="doPushingCard()">保存</a>
		<a class="easyui-linkbutton" iconcls="icon-save" style="margin:40px 0 0 5px;display: none" id="updatePower" onclick="doPushingCard()">修改</a>
		<a class="easyui-linkbutton" iconcls="icon-cancel" style="margin:40px 0 0 5px;display: none" id="deletePower" onclick="deletePower()">刪除</a>
	</div>
</div>
