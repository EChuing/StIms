...
<body>
	...
	<div style="width:20%;float:left;">
		<div>
			<div style="padding:5px 0 5px 5px;">
				<a class="easyui-linkbutton" iconCls="icon-fabu" plain="true" onclick="addApartmentDlg()">添加门店</a>
	...
	<div style="width:20%;float:left;">
		<div style="padding:5px 0 5px 5px;">
			<a class="easyui-linkbutton" iconCls="icon-fabu" plain="true" onclick="addLayoutDlg()">添加房型</a>
	...
	<div style="width:60%;float:left;">
		<div style="padding:5px 0 5px 5px;">
			<a class="easyui-linkbutton" iconCls="icon-fabu" plain="true" onclick="addRoomDlg()">添加房间</a>
			<a class="easyui-linkbutton" iconCls="icon-bianji" plain="true" onclick="updateRoomDlg()">修改房间</a>
		</div>
		<!-- 房间列表 -->
		<div>
	...
	<div id="addApartmentDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style='margin:5px 0 0 0;'>
			<div style='margin:5px 0 0 5px;'>
				<div>退租声明：</div>
				<textarea id="unrent" style="margin:5px 0 0 0;width:900px;height:50px;" require="require" clear="clear" placeholder="描述50-500字符">
				</textarea>
			</div>
		</div>
		<div style='margin:5px 0 0 0;'>
			<div style='margin:5px 0 0 5px;'>
				<div>转租声明：</div>
				<textarea id="sublet" style="margin:5px 0 0 0;width:900px;height:50px;" require="require" clear="clear" placeholder="描述50-500字符">
				</textarea>
			</div>
		</div>
		<div style="clear:both"></div>
	...
	<div id="updateApartmentDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style='margin:5px 0 0 0;'>
			<div style='margin:5px 0 0 5px;'>
				<div>退租声明：</div>
				<textarea id="unrent2" style="margin:5px 0 0 0;width:900px;height:50px;" require="require" clear="clear" placeholder="描述50-500字符">
				</textarea>
			</div>
		</div>
		<div style='margin:5px 0 0 0;'>
			<div style='margin:5px 0 0 5px;'>
				<div>转租声明：</div>
				<textarea id="sublet2" style="margin:5px 0 0 0;width:900px;height:50px;" require="require" clear="clear" placeholder="描述50-500字符">
				</textarea>
			</div>
		</div>
		<div style="clear:both"></div>
	...
	<script src="js/fg.58PushRoom.js"></script>
