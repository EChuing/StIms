...
<body>
    ...
    <div>
        ...
        <a class="easyui-linkbutton" iconCls="icon-zukeyixiangrenguanli"
           plain="true" id="associatedPersonnelButton" onclick="officeAssociatedUsers(0)">教师授权</a>
        </div>
        <div style="clear:both"></div>
        <div style="margin:5px 0 5px 5px; float:left; color:black;">
            <label for="searchVirtualName">教室/办公室名称</label>
            <input style="width:100px;" id="searchVirtualName" onkeyup="queryOfficeAreaDevice()">
        </div>
        <div style="clear:both"></div>
    </div>
...
<%--                    <th field="idstName" width="10" align="center">二级名称</th>--%>
                    ...
                    <th field="devStatus" width="20" align="center">设备状态</th>
<%--                    <th field="switchingState" width="10" align="center">开关状态</th>--%>
        ...
        <div id="deviceType" style="margin-left: 8px; width:30%; height:523px;float:left;">
            <div id="tt" class="easyui-tabs" style="width:100%;height:523px;float:left;" data-options="closable:false" >
                <div title="灯光控制" id="lightingControllerDiv" style="padding:20px;width: 50px; float:left;margin-left:0px;">
                ...
                <div title="灯光调节" id="lightingContrller" style="padding:20px;width:50px; float:left;">
                ...
                <div title="插座控制" id="socketContrller" style="padding:20px;width:50px; float:left;">
                    <div class="controllerCls">
                        <input class="buttonCls"  id="openAllCocket" type="button" ctlType="0" value="全部打开"  >
                    </div>
                    <div class="controllerCls">
                        <input class="buttonCls"  id="closeAllCocket" type="button" ctlType="1" value="全部关闭" style="margin-left: 20px;" >
                    </div>
                </div>
            </div>
