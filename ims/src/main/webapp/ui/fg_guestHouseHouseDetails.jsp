...
<div id="houseInfoDlg" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true">
    ...
    <div style="float:left;margin:10px 0 0 10px">
        客房状态：<input  id="houseState" cleartwo="cleartwo"  style="width:120px;"/>
    </div>
    <div style="float:left;margin:10px 0 0 10px">
    ...
    <div id="shortHouseTypeDiv" style="float:left;margin:10px 0 0 5px">
        客房类型：<select id="shortHouseType" style="width:90px;" cleartwo="cleartwo">
    </select>
    </div>
    <div style="float:left;margin:10px 0 0 10px">
        门店地址：<input   id="houseAddress" cleartwo="cleartwo"  style="width:470px;"/>
    </div>
    ...
    <div style="float:left;margin:10px 0 0 4px">
        客房标题：<input   id="hsHouseTitle" cleartwo="cleartwo"  style="width:631px;"/>
    </div>
    ...
    <div style="clear:both"></div>
    <div style="float:left;margin:10px 0 0 4px">
        客房详情：<input   id="hsHousingIntroduction" cleartwo="cleartwo"  style="width:631px;"/>
    </div>
    <!-- 房间配置 -->
    ...
    <div style="clear:both"></div>
    <center id="action" style="margin:20px 0 0 0">
    ...
    <div id="doorCardManagement" style="padding:6px;text-align:center" class="easyui-dialog" data-options="closed:true">
        <div id="management" style="float:left;margin:5px 0 0 0;">
            <button id="" style="background-color: #4CAF50;border: none;color: white;text-align: center;text-decoration: none;display: inline-block;-webkit-transition-duration: 0.4s;transition-duration: 0.4s;cursor: pointer;background-color: white;color: black;border: 2px solid #e7e7e7;" onclick="logoutDoorCart(1)">注销门卡</button>
            <button id="" style="margin:0 0 0 30px;background-color: #4CAF50;border: none;color: white;text-align: center;text-decoration: none;display: inline-block;-webkit-transition-duration: 0.4s;transition-duration: 0.4s;cursor: pointer;background-color: white;color: black;border: 2px solid #e7e7e7;" onclick="logoutDoorCart(2)">退房退卡</button>
        </div>
