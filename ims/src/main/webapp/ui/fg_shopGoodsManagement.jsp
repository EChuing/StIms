...
<body>
	...
	<div>
		...
		<div>
			<div style="padding:5px 0 5px 5px;">
		        ...
		        <a class="easyui-linkbutton" iconCls="icon-shangchushangping" plain="true" onclick="openDeleteGoods()">删除商品</a>
	...
	<div id="addGoodsDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style="clear:both"></div>
		<a style='margin:5px 0 0 12px;' class="easyui-linkbutton" iconCls="icon-fujian" plain="false" onclick="openAttachment('public')">上传</a>
	...
	<div id="goodsDetailDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<a class="easyui-linkbutton" iconCls="icon-chakantupian" plain="true" onclick="open_common_img_dialog('public', 'fly', 'goodsDg', 'id', 'cgImgPath', 'listGoods', 'deleteImg')">上传及查看图片</a>
		<a class="easyui-linkbutton" iconCls="icon-shengchenggongzibiao" plain="true" onclick="openGoodsIntroduce()">商品介绍</a>
		<div style="clear:both"></div>
		<center style="margin:5px 0 0 0;">
			<a class="easyui-linkbutton updateNone" iconcls="icon-up" onclick="lastOrNext(0, 'goodsDetail_index', 'goodsDg', 'goodsDetailDlg', 'openGoodsDetail(row)')">上一条</a>
			<a id="beginUpdateGoods"  class="easyui-linkbutton  updateNone" iconcls="icon-save" onclick="beginUpdateGoods()">修改</a>
			<a id="doUpdateGoods"  style="display:none" class="easyui-linkbutton  update" iconcls="icon-save" onclick="doUpdateGoods()">保存</a>
			<a class="easyui-linkbutton updateNone" iconcls="icon-cancel" onclick="$('#goodsDetailDlg').dialog('close')">关闭</a>
			<a class="easyui-linkbutton update" style="display:none" iconcls="icon-cancel" onclick="cancelUpdateGoods()">取消</a>
			<a class="easyui-linkbutton updateNone" iconcls="icon-down" onclick="lastOrNext(1, 'goodsDetail_index', 'goodsDg', 'goodsDetailDlg', 'openGoodsDetail(row)')">下一条</a>
		</center>
	</div>
	...
	<div id="goodsInventoryDlg" style="padding:6px;" class="easyui-dialog" data-options="closed:true">
		...
		<div style="float:left;margin:2% 0 0 15%">
			<input id="inventorySearchGoods" list="goodsList" clear="clear" style="width:450px;height:35px;border-radius:5px" placeholder="请输入 商品编号/商品名称" />
		</div>
		<div style="clear:both"></div>
	...
	<div id="goodsPurchaseDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div style="float:left;margin:2% 0 0 1%">
			<input id="searchInput" list="goodsList" class="clean" style="width:450px;height:35px;border-radius:5px" placeholder="请输入 商品编号/商品名称" />
		</div>
		<div style="float:left;margin:2% 0 0 2%">
			<button type="button" onclick="addGoodsPurchase()" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;">添加</button>
		</div>
		<div style="clear:both"></div>
		<div id="purchaseGoodsGrid" style="width:90%;margin:1% 0 0 5%" >
			<table id="purchaseGoodsDg" style="width:100%;height:300px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
		...
		<div style="text-align:center;">
			<div style="float:left;margin:2% 0 0 8%">
				...
				<div style="float:left;margin:2% 0 0 0">
					<input id="supplier" class="clean" onfocus="choseHouse()" style="width:170px;height:35px;border-top: 0;border-left: 0;border-right: 0;font-size:20px"/>
				</div>
			</div>
			<div style="float:left;margin:2% 0 0 5%">
				...
				<div style="float:left;margin:2% 0 0 0">
					<input type="date" class="clean" id="purchaseDate" style="width:170px;height:35px;border-top: 0;border-left: 0;border-right: 0;font-size:20px"/>
				</div>
			</div>
			<div style="float:left;margin:2% 0 0 5%">
				<div style="float:left;margin:3.5% 0 0 0;font-size:20px">
				...
				<div style="float:left;margin:2% 0 0 0">
					<input class="clean" id="purchaseTotalPrice" readonly="readonly" style="width:170px;height:35px;border-top: 0;border-left: 0;border-right: 0;font-size:20px"/>
				</div>
			</div>
		</div>
		<div style="clear:both"></div>
		<div style="text-align:center;">
			<div style="float:left;margin:2% 0 0 40%">
				<button type="button" class="btn btn-success" style="margin:0 0 5px 5px;width:140px;" onclick="doPurchase()">入库</button>
			</div>
		</div>
	</div>
	...
	<div id="purchaseOrderDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div id="purchaseOrderGrid" style="width:100%;margin:1% 0 0 0%" >
			<table id="purchaseOrderDg" style="width:100%;height:300px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
	...
	<div id="purchaseOrderDetailDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div id="purchaseOrderDetailGrid" style="width:100%;margin:1% 0 0 0%" >
			<table id="purchaseOrderDetailDg" style="width:100%;height:200px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
		...
		<center style="margin:15px 0 0 0;">
			<a class="easyui-linkbutton" iconcls="icon-up" onclick="lastOrNext(0, 'purchaseOrderDetail_index', 'purchaseOrderDg', 'purchaseOrderDetailDlg', 'openPurchaseOrderDetail(row)')">上一条</a>
			<a class="easyui-linkbutton" iconcls="icon-cancel" onclick="$('#purchaseOrderDetailDlg').dialog('close')">关闭</a>
			<a class="easyui-linkbutton" iconcls="icon-down" onclick="lastOrNext(1, 'purchaseOrderDetail_index', 'purchaseOrderDg', 'purchaseOrderDetailDlg', 'openPurchaseOrderDetail(row)')">下一条</a>
		</center>
	</div>
	...
	<div id="checkGoodsDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div id="checkGoodsGrid" style="width:100%;margin:1% 0 0 0%" >
			<table id="checkGoodsDg" style="width:100%;height:276px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
	...
	<div id="menu" class="easyui-menu" style="width:120px;">
		<div><a class="easyui-linkbutton" iconCls="icon-shangpingshangjia" plain="true"   onclick="changeOnSale(1)">上架</a></div>
		<div><a class="easyui-linkbutton" iconCls="icon-shangpingxiajia" plain="true"   onclick="changeOnSale(0)">下架</a></div>
		<div><a class="easyui-linkbutton" iconCls="icon-shangchushangping" plain="true" onclick="openDeleteGoods()">删除商品</a></div>
	</div>
	...
	<div id="discountDlg" class="easyui-dialog" data-options="closed:true">
		...
		<div id="discountGrid" style="width:100%;margin:0.5% 0 0 0%" >
			<table id="discountDg" style="width:100%;height:276px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
	...
	<div id="addSNDlg" style="padding:6px" class="easyui-dialog" data-options="closed:true">
		...
		<div id="addSnDataGrid" style="width:100%;height:220px;">
			<table id="addSnTable" style="width:100%;height:200px;table-layout:fixed;overflow:hidden;" class="easyui-datagrid"
				data-options="rownumbers:false, singleSelect:true, autoRowHeight:false, pageSize:10, fitColumns:true, scrollbarSize:0">
				<thead>
					<tr>
