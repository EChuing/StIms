...
<!--短租订单管理工具-->
<div style="padding:10px 0 10px 5px;float:left">
    <div style="margin:0 0 0 10px;float:left">
        门店名称 : <input id="searchHsAddCommunity" onkeyup="getAllShortRentOrder(1,0)" />
    </div>
    <div style="margin:0 0 0 22px;float:left">
        门牌号 : <input id="searchHsAddDoorplateno" onkeyup="getAllShortRentOrder(1,0)" />
    </div>
    <div style="margin:0 0 0 10px;float:left">
        客户姓名 : <input id="searchRenterName" onkeyup="getAllShortRentOrder(1,0)" />
    </div>
    <div style="margin:0 0 0 10px;float:left">
        订单号 : <input id="searchSaleNo" onkeyup="getAllShortRentOrder(1,0)" />
    </div>
    ...
    <div id="hiddenScreen" style="display:none">
        ...
        <div style="margin:0 0 0 10px;float:left">
            入住时间 : <input id="searchOrderStartTime" type="text"
            ...
            到 <input id="searchOrderEndTime" type="text"
