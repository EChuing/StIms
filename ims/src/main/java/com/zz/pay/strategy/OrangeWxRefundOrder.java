...
public class OrangeWxRefundOrder implements RefundOrderStrategy{

	@Override
	public Result<String> refundOrder(Map<String, String> map) throws Exception {
		String url = PayManage.OrangePay.WXREFUNDORDERURL;
		...
		//接口类型
		sendMap.put("service", PayManage.OrangePay.WXREFUNDORDERSERVICE);
		//随机字符串
		...
		System.out.println("桔橙在线支付退单前的数据  = "+sendMap.toString());
		...
		System.out.println("桔橙在线支付退单返回的结果  = "+resultMap);
