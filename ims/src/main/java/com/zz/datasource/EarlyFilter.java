...
public class EarlyFilter extends HttpServlet implements Filter {
    @Override
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2) throws IOException {
        ...
        if(user != null){
            sess.invalidate();
//            try {
//                //req.getRequestDispatcher("fg_early_warning.jsp").forward(req, resp);
...
//            }
        ...
        try (SqlSession sqlSession = MySqlSessionFactory.newSqlSessionFactory().openSession()) {
            ...
            if (dataSource != null && dataSource.getState() != 0) {
                ...
                String wxMerchantName = dataSource.getWxMerchantName();
                ...
                sess.setAttribute("wxMerchantName",wxMerchantName);
