...
public interface WegReadingService {
	//查询所有-数据和统计分开
    ...
    //已租房添加抄表
    int addedMeterReading(JournalWegReading record, int temp) throws Exception;
    
    //根据抄表读数查抄表日期
    List<JournalWegReading> selectWegDate(JournalWegReading record) throws Exception;
    
    //条件筛选
	List<JournalWegReading> conditionSelectWegReading(JournalWegReading conditions) throws Exception;
